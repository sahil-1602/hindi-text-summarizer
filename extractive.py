...
article_name = parent_directory + "/method_1/valid/article.txt"
print("Summarizing article...")
with open(article_name, 'r', encoding="utf8") as f:
    sentences = f.readlines()

# store stopwords
stopword_dir = parent_directory + "/method_1/stopwords.txt"
with open(stopword_dir, 'r', encoding="utf8") as s:
...
summary_name = parent_directory + "/method_1/valid/summary.txt"
